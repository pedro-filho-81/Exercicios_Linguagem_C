/*
   Função: 5.53 Instrução auxiliada por computador: níveis de  dificuldade.
   ...
   com um nível de dificuldade. Em um nível de  dificuldade 1, o programa
   deverá usar apenas números  de um dígito nos problemas; em um nível de
   dificuldade  2, os números podem ter dois dígitos e assim por diante.
...
int main()
{
   ...
   while( nivel != 0 ) // primeiro while
   {
      ...
      // Cabeçalho
      printf( "\n{ Tabuada de Multiplicar nível %d [0 = sair]}\n", nivel );

      // confere recebe o valor da multiplicação
      confere = multi( n1, n2 );
      ...
      while( nivel != 0 )
      {
         ...
         { // se verdade
            ...
            boa_msg = 1 + rand() % 4;
            // chamar a função boas mensagens
            msg_boa( boa_msg );
         ...
         else
         {
            ...
            // ruim mensagem recebe valor aleatório entre 1 e 4
            ruim_msg = 1 + rand() % 4;
