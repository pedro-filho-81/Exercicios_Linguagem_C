/*
   Ponteiros: 2) Escreva um programa que contenha duas variáveis
   inteiras. Leia essas variáveis do teclado. Em seguida, compare
...
int main()
{
   ...
   // CABEÇALHO
   printf( "{ MAIOR ENDEREÇO E O VALOR DA VARIÁVEL É }\n" );

   // VERIFICA O MAIOR ENDEREÇO r mostrar conteúdo
   ...
   if( n1Ptr > n2Ptr )
      ...
      printf( "O endereço da variável n1 = %d é maior que"
             ...
             "O CONTEÚDO da variável n1 é %d\n"
             "o CONTEÚDO da variável n2 é %d\n",
             n1Ptr, n2Ptr, *n1Ptr, *n2Ptr );
